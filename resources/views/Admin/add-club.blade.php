                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('add-club') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg" id="club_name" name="club_name"
                                    placeholder="Enter club name" <?php if (isset($club)) {
                                        echo 'value="' . $club->club_name . '"';
                                    } ?> required>
                            </div>
                            <div class="mb-3">
                                ...
                                <select class="form-select form-select-lg" id="meeting_day" name="meeting_day" required>
                                    ...
                                    <option <?php if (isset($club)) {
                                        if ($club->meeting_day == 'Monday') {
                                            echo 'selected';
                                        }
                                    } ?> value="Monday">Monday</option>
                                    <option <?php if (isset($club)) {
                                        if ($club->meeting_day == 'Tuesday') {
                                            echo 'selected';
                                        }
                                    } ?> value="Tuesday">Tuesday</option>
                                    <option <?php if (isset($club)) {
                                        if ($club->meeting_day == 'Wednesday') {
                                            echo 'selected';
                                        }
                                    } ?> value="Wednesday">Wednesday</option>
                                    <option <?php if (isset($club)) {
                                        if ($club->meeting_day == 'Thursday') {
                                            echo 'selected';
                                        }
                                    } ?> value="Thursday">Thursday</option>
                                    <option <?php if (isset($club)) {
                                        if ($club->meeting_day == 'Friday') {
                                            echo 'selected';
                                        }
                                    } ?> value="Friday">Friday</option>
                                    <option <?php if (isset($club)) {
                                        if ($club->meeting_day == 'Saturday') {
                                            echo 'selected';
                                        }
                                    } ?> value="Saturday">Saturday</option>
                                    <option <?php if (isset($club)) {
                                        if ($club->meeting_day == 'Sunday') {
                                            echo 'selected';
                                        }
